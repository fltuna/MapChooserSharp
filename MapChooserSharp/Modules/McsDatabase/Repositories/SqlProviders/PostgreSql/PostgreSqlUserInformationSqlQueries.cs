...
internal sealed class PostgreSqlUserInformationSqlQueries(string tableName) : IMcsUserInformationSqlQueries
{
    ...
    public string GetEnsureTableExistsSql() => @$"
        CREATE TABLE IF NOT EXISTS {TableName} (
            ...
            UserSessionStartedAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
        )";
