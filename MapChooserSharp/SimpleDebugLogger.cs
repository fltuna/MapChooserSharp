...
{
    public readonly FakeConVar<int> DebugLogLevelConVar = new("mcs_debug_level",
    ...
    public readonly FakeConVar<bool> PrintToAdminClientsConsoleConVar = new("mcs_debug_show_console", "Debug message shown in client console?", false);
    
    public readonly FakeConVar<string> RequiredFlagForPrintToConsoleConVar = new ("mcs_debug_console_print_required_flag", "Required flag for print to client console", "css/generic");
    ...
    public override string LogPrefix => "[MCS]";

    
    private const string ModuleName = "DebugLoggerMCS";
