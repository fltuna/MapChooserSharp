...
/// Event of nomination
/// </summary>
public class McsNominationBeginEvent(CCSPlayerController? player, IMapConfig mapConfig, string modulePrefix) : McsNominationEventBase(modulePrefix), IMcsEventWithResult
{
    /// <summary>
